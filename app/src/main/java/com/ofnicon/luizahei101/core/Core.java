...
import com.ofnicon.luizahei101.activities.MainActivity;
import com.ofnicon.luizahei101.activities.NotificationActivity;
...
import static com.ofnicon.luizahei101.core.NotificationWorker.TAG;
...
public class Core {
    ...
    public static String getBackground(Context context) {
        String[] bgArray = context.getResources().getStringArray(R.array.bg_list);
        Random r = new Random();
        int bgNum = r.nextInt(bgArray.length);
        return bgArray[bgNum];
    }
